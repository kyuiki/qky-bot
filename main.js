...
client.on('message', (msg) =>{
	...
	if(command.nsfw && !msg.channel.nsfw){
		return msg.channel.send({embed:{title:"NSFW Command is Forbidden!", description:"Sorry! We cant send any NSFW Stuff here! Use NSFW commands in a NSFW marked channel (Open channel setting and mark as NSFW)",color:0xed2222,image:{url:'https://i.imgur.com/oe4iK5i.gif'}}})
	}
